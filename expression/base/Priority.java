...
public class Priority {
    ...
    public static final int MAX_PRIORITY = 11;
    ...
    public static final int LOG_PRIORITY = 40;
    public static final int POW_PRIORITY = 40;

    public static final int OPERAND_PRIORITY = 100;
}
